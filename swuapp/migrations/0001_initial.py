# Generated by Django 2.1 on 2020-02-21 16:37
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='UserLecture',
            fields=[
                ('User', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='myuserid', serialize=False, to='swuapp.User', unique=True)),
                ...
                ('mysemester', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='mysemester', to='swuapp.Lecture', to_field='semester')),
            ],
        ),
    ]
